...
const T = {
  fr: {
    ...
    explainerFree: ["L'objet est disponible → c'est gratuit", ", demandez-le simplement à la réception."] as const,
    explainerResa: ["Vous voulez être sûr qu'il soit dispo ? Alors ", "réservez-le", " — le prix est indiqué sur chaque objet."] as const,
  ...
  en: {
    ...
    explainerFree: ["The item is available → it's free", " — just ask at the front desk."] as const,
    explainerResa: ["Want to make sure it's yours? ", "Reserve it", " — the price is shown on each item."] as const,
