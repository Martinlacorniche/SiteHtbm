...
const CONFIG = {
  ...
  texts: {
    fr: {
      ...
      incl_night: "Nuit douce en chambre individuelle (Hôtel-Rooftop Les Voiles ou Corniche)",
    ...
    en: {
        ...
        incl_night: "Soft night in a single room (Hôtel-Rooftop Les Voiles ou Corniche)",
...
export default function GroupPackagesClient() {
